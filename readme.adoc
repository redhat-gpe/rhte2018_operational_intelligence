...
ifdef::showscript[]
If student lab environment and Oshinko Cluster were provisioned using the ocp-workload-rhte-mw-api-user1 ansible role, then student details can be found in:
...
. Delete the unwanted files (this step is optional)
image::https://github.com/Pkrish15/uber-datanalysis/blob/master/ocdelete.png[uber11]
...
This Section is still WIP will be completed by tommorrow.
