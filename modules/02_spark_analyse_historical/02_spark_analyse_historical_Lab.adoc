...
[red]#TODO:  Elaborate why this is needed.  Also, load data into config map rather than rsyncing into pod#
...
[red]#TODO:  Elaborate why this is needed.#
...
image::images/kmeansbusiness.png[kmb]
