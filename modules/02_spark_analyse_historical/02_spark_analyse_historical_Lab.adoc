...
ws://apache-zeppelin-developer-uber-data.apps.clientvm.5fd4.rhte.opentlc.com/ws.
This URL is unable to connect due to firewall block, Hence we are making it to as a secured route to communicate.
