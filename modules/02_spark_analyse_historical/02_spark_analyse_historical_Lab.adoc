...
. If you haven't done so already, make a new directory where all lab assets will reside:
+
-----
$ mkdir -p $HOME/lab
-----

. If you haven't done so already, clone the lab assets:
+
-----
$ git clone https://github.com/gpe-mw-training/operational_intelligence.git $HOME/lab/operational_intelligence
-----

. Change directories to the `uber-data-analysis` directory of the newly cloned project:
+
-----
