...
image::https://github.com/redhat-gpe/rhte_lab_06_operational_intelligence/blob/master/modules/02_spark_analyse_historical/images/LoadData1.png[LoadData]
...
image::https://github.com/redhat-gpe/rhte_lab_06_operational_intelligence/blob/master/modules/02_spark_analyse_historical/images/CreateFeatureArray.png[FeatureArray]
...
image::https://github.com/redhat-gpe/rhte_lab_06_operational_intelligence/blob/master/modules/02_spark_analyse_historical/images/KMeansModel.png[FeatureArray]

.. Next, we use the model to get the clusters for test data in order to further analyze the clustering.

image::https://github.com/redhat-gpe/rhte_lab_06_operational_intelligence/blob/master/modules/02_spark_analyse_historical/images/Predictions.png[Predictions]
...
image::https://github.com/redhat-gpe/rhte_lab_06_operational_intelligence/blob/master/modules/02_spark_analyse_historical/images/zeppelinArchitecture.jpg[za]
...
A finally, you can find the Zeppelin running by accessing the Route URL. Configuration changes has to be made in Zeppelin Interpreter for our use case.
