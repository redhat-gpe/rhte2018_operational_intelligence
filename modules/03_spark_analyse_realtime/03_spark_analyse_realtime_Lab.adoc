...
$ oc new-project  -n $OCP_PROJECT
  oc new-project uber-realtimedata-analysis
-----
...
...
--> Deploying template "uber-realtimedata/apache-zeppelin-openshift" for "/apache-zeppelin-openshift" to project uber-data-analysis
