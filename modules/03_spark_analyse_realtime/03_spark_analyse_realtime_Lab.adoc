...
* Kafka Spark Streaming of Uber.csv file.
* Apache Spark Deployment using Apache Zeppelin on Oshinko Cluster
* Uber Realtime Data Analysis using Apache Spark
...
Zeppelin has a built in Scala and Python Interpretors.
...
+
==Red - To be Changed to SparkProducerConsumer.scala
-----
├── templates
