...
+
----
$ curl -f -v -k -X GET "https://raw.githubusercontent.com/gpe-mw-training/operational_intelligence/master/uber-realtime-spark-stream-analysis/data/uber.csv" > uber.csv
----
