...
echo "export OCP_PASSWD=admin" >> ~/.bashrc
...
$ export OCP_PROJECT=developer-lab1-kafka-project
-----
...
-----
+
. Download data file in csv format, using this command
+
----
$ curl -f -v -k -X GET "https://raw.githubusercontent.com/gpe-mw-training/operational_intelligence/master/uber-realtime-spark-stream-analysis/data/uber.csv" > /tmp/uber.csv
----
