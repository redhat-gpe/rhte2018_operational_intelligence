...
Your lab environment includes access to a pre-installed Kafka cluster.
...
... Expect this pod to be in a `Running` state after one restart.
... A sample log file immediately after a successful start-up can be found link:https://gist.github.com/jbride/7ccc27fd6970db980434c55289709e43[here].

... [red]#TODO:   What functionality does this provide ?#
