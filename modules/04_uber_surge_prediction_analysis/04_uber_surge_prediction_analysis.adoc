...
= Uber Surge Prediction Analysis using Apache Spark and RHDM
...
** Knowledge of RedHat Decision Manager
...
=== Lab Goals
. This Lab will provide you large datasets of UberData.
. Surge Prediction Analysis of Uber on various constrains.
...
-----
echo "export OCP_PROJECT=\$OCP_USERNAME-uber-surge-prediction-analysis" >> ~/.bashrc
